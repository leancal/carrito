...
@Entity
public class CarritoPromocionable {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @GenericGenerator(name = "native", strategy = "native")
    private long id;

    @OneToMany(mappedBy = "carritoPromocionable")
    ...
    public CarritoPromocionable() {
    }

    public CarritoPromocionable( String nombreProductoAgregado, int cantidadLlevada, double precio) {
