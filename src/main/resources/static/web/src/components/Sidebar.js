  ...
  return (
    ...
    >
      <div className="flex items-center justify-between py-6 border-b">
        <div className="uppercase text-sm font-semibold">Carrito de Compras ({itemAmount})</div>
        {/*icon*/}
        <div
          onClick={handleClose}
      ...
      <div className="flex flex-col gap-y-2 h-[500px] lg:h-[640px] overflow-y-auto overflow-x-hiden border-b ">
        {cart.map((item) => {
